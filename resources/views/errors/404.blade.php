...
<body class="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
    <section class="relative isolate grid min-h-screen place-items-center overflow-hidden px-6 py-24">
        ...
        <div class="container relative max-w-4xl text-center">
            <!-- Illustration: floating island + 404 -->
            ...
            <p class="mt-6 text-sm font-semibold tracking-widest text-emerald-300">PAGE NOT FOUND</p>
            <h1 class="mt-1 text-2xl font-bold text-white/90 sm:text-3xl">We couldn’t find that aisle</h1>
            <p class="mx-auto mt-3 max-w-2xl text-white/70">
                The page might be out of stock or moved. Try the homepage or browse our categories.
            </p>
